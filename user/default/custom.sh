...
#修改openwrt_release版本
sed -i 's#R[0-9].*\('\''\)#R20.4.24\1#g'   package/lean/default-settings/files/zzz-default-settings
sed -i 's/https:/R20.4.24/g' package/lean/default-settings/files/zzz-default-settings
